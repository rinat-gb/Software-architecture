# Домашнее задание для одиннадцатого семинара "Урок 11. Сервис-ориентированные архитектуры"
...
## 1. ER диаграмма данных хранимых в облаке

![](erd_vacuum_cleaner.png)
...
paths:
  ...
  /Group/updateById/{groupId}:
    put:
      ...
      description: Обновить группу в базе
  ...
  /Robot/findById/{robotId}:
    get:
      ...
      description: Поиск робота-пылесоса в базе
...
## 3. UML диаграмма микро сервиса аутентификации на основе токенов безопасности

![](uml_vacuum_cleaner.png)
